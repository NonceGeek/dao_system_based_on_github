defmodule DAOSystemBasedOnGithubWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DAOSystemBasedOnGithubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DAOSystemBasedOnGithubWeb.Gettext, "errors", msg, opts)
    end
  end
